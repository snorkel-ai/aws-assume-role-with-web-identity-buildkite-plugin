...
# optionally set the OIDC token lifetime (defaults to 900s if role-session-duration is set)
...
elif [[ -n "${BUILDKITE_PLUGIN_AWS_ASSUME_ROLE_WITH_WEB_IDENTITY_ROLE_SESSION_DURATION:-}" ]]; then
  request_token_cmd+=(--lifetime 900)
fi
